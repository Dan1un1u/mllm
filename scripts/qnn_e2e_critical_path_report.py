...
def main():
    ...
    payload = json.dumps(
        {"speed": speed, "accuracy": accuracy_public, "graphs": graphs},
        ensure_ascii=False,
        separators=(",", ":"),
    ).replace("</", "<\\/")
