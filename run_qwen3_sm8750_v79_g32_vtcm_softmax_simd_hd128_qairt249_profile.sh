...
# Profile the head_dim=128 scale-fused SIMD/VTCM masked-Softmax candidate
# against the selected QAIRT 2.49 native-Softmax RMSNorm-U8 baseline.

script_dir="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
artifact_root="${ARTIFACT_ROOT:-/mnt/d/llm_exp}"

export ARTIFACT_ROOT="${artifact_root}"
export CONTRACT_FILE="${artifact_root}/models/qwen3_sm8750_v79/g32/w4a8_rmsnorm_u8_vtcm_softmax_simd_hd128_qairt249/20260823/p19/profile-contract.env"
export RESULT_PREFIX="qwen3_sm8750_v79_w4a8_rmsnorm_u8_vtcm_softmax_simd_hd128_qairt249_p19"
...
export REMOTE_DIR="${REMOTE_DIR:-/data/local/tmp/mllm_w4a8_vtcm_softmax_simd_hd128_qairt249}"
